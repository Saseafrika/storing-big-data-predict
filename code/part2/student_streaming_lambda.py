...
def lambda_handler(event, context):
    ...
    __TableName__ = 'DESIBDLO-streaming-dynamodb' # <-- Insert your table name
    ...
    table = dynamodb.Table('DESIBDLO-streaming-dynamodb') # <-- Write code to update the value of this variable.
    # ===================================================================================
